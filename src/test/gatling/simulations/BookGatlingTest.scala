...
class BookGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Book entity")
        ...
        .repeat(2) {
            ...
            .post("/api/books")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "subtitle":"SAMPLE_TEXT", "ibsn":"SAMPLE_TEXT", "editionNumber":"0", "keywords":"SAMPLE_TEXT", "publicationDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
